...
%----------------------------------------------------------------------------------------
  ...
  % HEADING SECTIONS
  %----------------------------------------------------------------------------------------
  \textsc{\large Facultatea Calculatoare, Informatică și Microelectronică}\\[0.5cm]
  \textsc{\large Universitatea Tehnică a Moldovei}\\[1.2cm] % Name of your university/college
  \vspace{25 mm}
...
\newcommand{\HRule}{\rule{\linewidth}{0.5mm}} % Defines a new command for the horizontal lines, change thickness here
  ...
  \vspace{10 mm}
  \HRule \\[0.4cm]
  { \LARGE \bfseries Version Control Systems și modul de setare a unui server  }\\[0.4cm] % Title of your document
  \HRule \\[1.5cm]
